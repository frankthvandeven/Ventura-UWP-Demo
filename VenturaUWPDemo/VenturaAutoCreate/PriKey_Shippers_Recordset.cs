...
namespace Demo.VenturaAutoCreate
{
	...
	public partial class PriKey_Shippers_Recordset : ResultsetObservable<PriKey_Shippers_Recordset, PriKey_Shippers_Record>, IRecordsetBase
	{
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipperID; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipperID = value; }
		}
		...
		{
			get { return new byte[] { 92, 247, 224, 144, 153, 100, 178, 171, 215, 78, 116, 172, 92, 153, 132, 23 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5CF7E0909964B2ABD74E74AC5C998417"; }
		}
	...
	public sealed partial class PriKey_Shippers_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		void IRecordBase.ValidateBeforeSaving(int record_index_to_display)
		{
			...
			if (_mod__ShipperID == false) throw new Exception(string.Format(VenturaStrings.VALUE_NOT_SET_MSG, record_index_to_display, "ShipperID"));
		}
