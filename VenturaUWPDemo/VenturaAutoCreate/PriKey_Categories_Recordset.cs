...
namespace Demo.VenturaAutoCreate
{
	...
	public partial class PriKey_Categories_Recordset : ResultsetObservable<PriKey_Categories_Recordset, PriKey_Categories_Record>, IRecordsetBase
	{
		...
		{
			get { return new byte[] { 126, 168, 191, 209, 215, 178, 28, 51, 30, 111, 203, 187, 131, 47, 19, 143 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "7EA8BFD1D7B21C331E6FCBBB832F138F"; }
		}
	...
	public sealed partial class PriKey_Categories_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Categories_Record(object[] columnvalues)
		{
			...
			_cur__Picture = (object)columnvalues[3];
			_cur__Thumbnail = (object)columnvalues[4];
		...
		void IRecordBase.ValidateBeforeSaving(int record_index_to_display)
		{
			...
			if (_mod__CategoryID == false) throw new Exception(string.Format(VenturaStrings.VALUE_NOT_SET_MSG, record_index_to_display, "CategoryID"));
		}
