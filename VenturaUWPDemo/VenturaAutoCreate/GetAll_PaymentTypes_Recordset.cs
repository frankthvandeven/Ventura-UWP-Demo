...
namespace Demo.VenturaAutoCreate
{
	...
	public partial class GetAll_PaymentTypes_Recordset : ResultsetObservable<GetAll_PaymentTypes_Recordset, GetAll_PaymentTypes_Record>, IRecordsetBase
	{
		...
		public GetAll_PaymentTypes_Recordset()
		{
			...
			schema_array.Add(new VenturaColumn("PaymentTypeID", typeof(long), false)
			{
				Updateable = true,
				IsKey = true,
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.PaymentTypeID; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.PaymentTypeID = value; }
		}
		...
		{
			get { return new byte[] { 146, 114, 250, 91, 226, 249, 84, 117, 117, 44, 17, 238, 83, 11, 175, 93 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "9272FA5BE2F95475752C11EE530BAF5D"; }
		}
	...
	public sealed partial class GetAll_PaymentTypes_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		void IRecordBase.ValidateBeforeSaving(int record_index_to_display)
		{
			...
			if (_mod__PaymentTypeID == false) throw new Exception(string.Format(VenturaStrings.VALUE_NOT_SET_MSG, record_index_to_display, "PaymentTypeID"));
		}
