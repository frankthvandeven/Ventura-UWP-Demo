...
namespace Ventura.Controls
{
    ...
    public class SmartToggleButton : ToggleButton, ISmartButton
    {
        ...
        static SmartToggleButton()
        {
            LabelProperty = DependencyProperty.Register(nameof(Label),
                typeof(string), typeof(SmartToggleButton),
        ...
        {
            (obj as SmartToggleButton).OnLabelPropertyChanged(args);
        }
        ...
        {
            (obj as SmartToggleButton).OnPathDataPropertyChanged(args);
        }
        ...
        public SmartToggleButton()
        {
            DefaultStyleKey = typeof(SmartToggleButton);
        }
